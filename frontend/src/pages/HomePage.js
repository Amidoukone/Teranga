          ...
          <div className="relative mx-auto max-w-6xl">
            ...
            <section className="mx-auto mt-8 max-w-5xl" aria-labelledby="home-services-title">
              ...
              <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
                ...
                <section
                  id="immobilier"
                  className="overflow-hidden rounded-[2rem] border border-amber-500/25 bg-surface-card shadow-sm sm:col-span-2"
                  aria-labelledby="home-property-listings-title"
                >
                  <div className="flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:p-6">
                    <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-amber-500/15 text-amber-700 dark:text-amber-300">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <h2 id="home-property-listings-title" className="mt-1 text-xl font-bold tracking-[-0.03em] text-text-primary sm:text-2xl">
                    ...
                    <Link
                      to="/immobilier"
                      className="btn-secondary inline-flex min-h-12 w-full shrink-0 items-center justify-center gap-2 rounded-2xl px-5 py-3 text-sm font-semibold sm:w-auto"
                    >
                  ...
                  {featuredListings.length > 0 ? (
                    <div className="grid gap-4 border-t border-border/70 bg-surface-main/50 p-4 sm:grid-cols-2 sm:p-5 lg:grid-cols-3">
            ...
            <ul className="mx-auto mt-8 grid max-w-5xl gap-3 sm:grid-cols-3" aria-label={t("homePage.simpleHero.trustLabel")}>
              {[
