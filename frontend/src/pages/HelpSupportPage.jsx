...
export default function HelpSupportPage() {
  ...
  return (
    <>
      <SetSeo title={t('seo.pages.helpSupport.title')} />

      <div className="app-page-wrap">
        <div className="app-page-shell space-y-8">
          <header className="space-y-2">
            <p className="page-kicker">{t('helpSupportPage.kicker')}</p>
            <h1 className="app-page-headline">{t('helpSupportPage.title')}</h1>
            <p className="app-page-subtitle">{t('helpSupportPage.subtitle')}</p>
          </header>
