const pageImporters = {
  ...
  missionCreate: () => import("../pages/MissionCreatePage"),
  ...
  adminPhoneOrders: () => import("../pages/AdminPhoneOrderPage"),
...
const routeMatchers = [
  ...
  [/^\/admin\/(?:taxi-dispatch|phone-orders)\/?$/i, [pageImporters.adminPhoneOrders]],
  ...
  [/^\/demandes\/nouvelle\/?$/i, [pageImporters.missionCreate]],
  [/^\/demandes\/?$/i, [pageImporters.services]],
  [/^\/dossiers\/?$/i, [pageImporters.dossiers]],
