const en = {
  ...
  adminProviderMobility: {
    ...
    driver: {
      ...
      licenseVerified: "Driver license verified",
    ...
    vehicle: {
      ...
      draftHint: "Only the type is needed to save. The other fields do not block creation and can be completed before activation.",
      type: "Type",
      motorcycle: "Motorcycle",
      car: "Car",
      ...
      registeredHint: "Vehicle successfully registered. Supporting documents can be added before making it assignable.",
      states: {
