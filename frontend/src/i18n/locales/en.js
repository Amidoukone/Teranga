const en = {
  ...
  adminProviderMobility: {
    ...
    saving: "Saving…",
    privateDocuments: "Supporting-document links are restricted to administrators. Clients only receive the useful identity of the assigned driver and vehicle.",
    ...
    driver: {
      ...
      licenseDocumentUrl: "Driver license document (private URL)",
      licenseExpiry: "Driver license expiry",
      licenseVerified: "Driver license verified",
      identityDocumentUrl: "Identity document (private URL)",
    ...
    documents: {
      ...
      number: "Number",
      url: "Supporting document (private URL)",
      expiry: "Expiry",
  ...
  mobilityBooking: {
    ...
    callUs: "Or call Teranga: {{phone}}",
    identity: {
      title: "How can we reach you?",
      hint: "We only ask for this when you book. If the number already exists, enter its PIN.",
      phone: "Phone",
      pin: "Teranga PIN",
    ...
    errors: {
      ...
      identity: "Enter your phone and PIN to book.",
  ...
  propertyListingsPage: {
    ...
    title: "Real estate listings",
    subtitle: "Houses, apartments and land for rent or sale — published by Teranga.",
    backHome: "Back to home",
    loading: "Loading…",
