const fr = {
  ...
  adminProviderMobility: {
    ...
    driver: {
      ...
      licenseVerified: "Permis vérifié",
    ...
    vehicle: {
      ...
      draftHint: "Seul le type est nécessaire pour enregistrer. Les autres champs ne bloquent pas la création et pourront être complétés avant l’activation.",
      type: "Type",
      motorcycle: "Moto",
      car: "Voiture",
      ...
      registeredHint: "Véhicule bien enregistré. Les justificatifs pourront être ajoutés avant de le rendre affectable.",
      states: {
