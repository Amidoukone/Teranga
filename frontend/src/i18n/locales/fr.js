const fr = {
  ...
  auth: {
    login: {
      kicker: "Espace s?curis?",
      title: "Connexion ? Teranga",
      subtitle: "Acc?dez ? votre espace s?curis?",
      ...
      forgotInfo:
        "Mot de passe oubli? ? Contactez l'admin ou le master de votre pays/r?gion pour le r?initialiser. Ensuite, vous pourrez le modifier dans votre compte.",
      submitting: "Connexion...",
      submit: "Se connecter",
      clientNoAccount: "Client : vous n'avez pas encore de compte ?",
      createAccount: "Cr?er un compte client",
      supportInfo: "Besoin d'un acc?s sp?cifique ? Contactez le support Teranga.",
      errorDefault: "?chec de connexion : identifiants incorrects.",
    },
    register: {
      kicker: "Rejoignez Teranga",
      title: "Cr?er un compte",
      subtitle: "Inscription pour les clients",
      subline: "Cr?ez votre acc?s client en quelques minutes.",
      firstName: "Pr?nom",
      ...
      countryExample:
        "Exemple : ML pour Mali, SN pour S?n?gal, CI pour C?te d'Ivoire.",
      countryDetected: "D?tect? :",
      regionInfo:
        "Compte r?gional ? Contactez l'admin ou le master de votre pays. L'inscription publique est r?serv?e au pays uniquement.",
      countriesLoading: "V?rification des pays disponibles...",
      ...
      passwordHide: "Masquer le mot de passe",
      passwordShow: "Afficher le mot de passe",
      passwordMin: "Minimum 8 caract?res.",
      submitting: "Cr?ation...",
      ...
      errors: {
        firstName: "Veuillez renseigner votre pr?nom.",
        ...
        loadingCountries: "V?rification des pays en cours...",
        countriesUnavailable:
          "Impossible de confirmer la disponibilit? des pays pour le moment.",
        countryNoMaster:
          "Nos services ne sont pas disponibles dans ce pays pour le moment.",
        generic: "Une erreur est survenue. V?rifiez vos informations.",
      },
    },
    forgotPassword: {
      title: "Mot de passe oubli?",
      subtitle: "Entrez votre email pour recevoir un lien de r?initialisation.",
      success: "Si un compte existe, un lien de r?initialisation a ?t? envoy?.",
      error: "Impossible d'envoyer la demande pour le moment.",
      debugTitle: "Mode debug actif (sans SMTP)",
      debugInfo: "Utilisez ce token/lien pour r?initialiser le mot de passe.",
      debugOpenLink: "Ouvrir le lien de r?initialisation",
      email: "Email",
      emailPlaceholder: "exemple@email.com",
      sending: "Envoi...",
      submit: "Envoyer le lien",
      recoveryCodeLink: "Utiliser un code de r?cup?ration",
      recoveryCodeInfo:
        "Les codes sont affich?s uniquement lors de leur g?n?ration.",
    ...
    resetPassword: {
      ...
      errors: {
        ...
        passwordMin: "Mot de passe trop court (minimum 8 caract?res).",
        passwordMismatch: "Les mots de passe ne correspondent pas.",
      },
    },
    recoveryCode: {
      title: "R?initialiser avec un code de r?cup?ration",
      subtitle:
        "Utilisez un code de r?cup?ration pour changer votre mot de passe.",
      help:
        "Ces codes sont remis lors de l'inscription ou apr?s r?g?n?ration depuis un compte connect?.",
      success: "Mot de passe r?initialis? avec succ?s.",
      error: "Impossible de r?initialiser le mot de passe.",
      newCodesTitle: "Nouveaux codes de r?cup?ration",
      newCodesInfo: "Conservez ces codes. Ils ne seront plus affich?s.",
      email: "Email",
      code: "Code de r?cup?ration",
      codePlaceholder: "ABCDE-12345",
      newPassword: "Nouveau mot de passe",
      confirmPassword: "Confirmer le mot de passe",
      submitting: "Validation...",
      submit: "R?initialiser avec un code",
      backToLogin: "Retour ? la connexion",
      errors: {
        passwordMin: "Mot de passe trop court (minimum 8 caract?res).",
        passwordMismatch: "Les mots de passe ne correspondent pas.",
    ...
    recoveryCodes: {
      ...
      subtitle:
        "Conservez ces codes dans un endroit s?r. Ils ne seront plus affich?s.",
      empty:
        "Aucun code disponible. V?rifiez que la migration recovery_codes est appliqu?e.",
      toLogin: "Aller ? la connexion",
      loginLink: "Connexion",
    },
  },
  common: {
